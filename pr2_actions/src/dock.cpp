...
void Dock::setPostconditions(StringMap parameters) {
...
void Dock::switchToDockMode() {
	...
	system("rosrun dynamic_reconfigure dynparam set /move_base_node/DWAPlannerROS \"{\'max_vel_x\': 0.1,\'max_vel_y\': 0.05,\'max_trans_vel\': 0.05, 		\'min_trans_vel\': 0.01,\'max_rot_vel\': 0.05,\'min_rot_vel\': 0.01, 		\'forward_point_distance\': 0.165,\'yaw_goal_tolerance\': 0.17, \'xy_goal_tolerance\': 0.05}\"");
}
void Dock::switchToNavMode() {
	system("rosrun dynamic_reconfigure dynparam set /move_base_node/local_costmap/inflation_layer  \"{\'inflation_radius\':0.55}\"");
	system("rosrun dynamic_reconfigure dynparam set /move_base_node/local_costmap \"{\'footprint\': \'[[-0.325,-0.325],[-0.325,0.325],[0.325,0.325],[0.46, 0.0],[0.325,-0.325]]\'}\"");
	system("rosrun dynamic_reconfigure dynparam set /move_base_node/local_costmap/obstacle_layer \"{\'unknown_threshold\': 8}\"");
	system("rosrun dynamic_reconfigure dynparam set /move_base_node/global_costmap/inflation_layer 	\"{\'inflation_radius\':0.55}\"");
	system("rosrun dynamic_reconfigure dynparam set /move_base_node/global_costmap \"{\'footprint\': \'[[-0.325,-0.325],[-0.325,0.325],[0.325,0.325],[0.46, 0.0],[0.325,-0.325]]\'}\"");
	system("rosrun dynamic_reconfigure dynparam set /move_base_node/global_costmap/obstacle_layer \"{\'unknown_threshold\': 8}\" ");
	system("rosrun dynamic_reconfigure dynparam set /move_base_node/DWAPlannerROS \"{\'max_vel_x\': 0.55,\'max_vel_y\': 0.1, \'max_trans_vel\': 0.55,\'min_trans_vel\': 0.1,\'max_rot_vel\': 1.0,\'min_rot_vel\': 0.3,\'forward_point_distance\': 0.325, \'yaw_goal_tolerance\': 0.17, \'xy_goal_tolerance\': 0.2}\"");
}
